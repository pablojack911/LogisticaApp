...
//                        Factura fact = (Factura) adapter.getGroup(groupPosition);
                    ...
                    else
                    {
                        ...
                        builder.setTitle("Rechaza cantidad item");
...
//                    final EditText etCantidadRechazada = (EditText) view.findViewById(R.id.etCantidadRechazada);
//                    final NumberPicker etCantidadRechazada = (NumberPicker) view.findViewById(R.id.etCantidadRechazada);
...
//                    etCantidadRechazada.setText(String.valueOf(0));
//                    etCantidadRechazada.setMinValue(0);
                        etCantidadRechazada.setMax(itemFactura.getCantidad());
